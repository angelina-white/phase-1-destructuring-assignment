...
const farmAnimalsCopy = [...farmAnimals.split(' ')];
farmAnimalsCopy.splice(1, 1)
const [bessie, dolly, babe, little] = farmAnimalsCopy;

// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of blackAndWhite, black, and pink.
const farmAnimalsCopy2 = [...farmAnimals.split(' ')];
farmAnimalsCopy2.splice(1, 1)
farmAnimalsCopy2.pop();
const [blackAndWhite, black, pink] = farmAnimalsCopy2;
